...
#	print "Move detected: ",datetime.datetime.now()
	...
	insert("INSERT INTO `MOVE_DETECTION`(`DATE`) VALUES (NOW())")	
#	time.sleep(2)
...
#         print "Humidity:    %.1f %%" % humidity
	  insert("INSERT INTO `HUMIDITY`(`DATE`, `VALUE`) VALUES (NOW(),'%.1f')" % humidity)
	  insert("INSERT INTO `TEMPERATURE`(`DATE`, `VALUE`) VALUES (NOW(),'%.1f')" % temp)
	  time.sleep(t)
